...
***
### Лабораторные работы:
1.  [Лабораторная работа 1. Построение бинарного дерева через рекурсию](https://replit.com/@ViktoriiaChiern/LR-1-4#main.py)
...
4.  [Лабораторная работа 4. Работа с Lector](https://github.com/vichnya/my_lektor)
    -  [Сайт на GitHub Pages - Lector](https://vichnya.github.io/my_lektor/)
...
8.  [Лабораторная работа 7. Работа с memory. Параметризованные запросы. Классы](https://replit.com/@ViktoriiaChiern/LR-7-4#main.py)
9.  [Лабораторная работа 8. Реализация Singleton для объекта класса](https://replit.com/@ViktoriiaChiern/LR-8-4#main.py)
10.  [Лабораторная работа 9. Реализация ORM](https://replit.com/@ViktoriiaChiern/LR-9-4#main.py)
